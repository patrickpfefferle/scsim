<?php
$this->pageTitle = Yii::app()->name . ' - ' . Yii::t('app', 'Benchmark of group delivery reliability');

$this->widget('application.components.amai.AmaiPageHeader', array(
    'header' => Yii::t('app', 'Delivery reliability'),
    'subtitle' => Yii::t('app', 'Benchmark of group delivery reliability')
));
